...
class BillingServiceTest {
    ...
    @Mock
    private ApartmentSourceConfigRepository configRepository;
    ...
    void shouldCalculateDailyCostSuccessfully() {
        ...
        when(configRepository.findByApartmentId(1L))
        ...
        verify(breakdownRepository)
                .save(any(DailyLogSourceBreakdown.class));
    }
    ...
    void shouldThrowExceptionWhenNoRatesFound() {
        ...
        RuntimeException exception =
                org.junit.jupiter.api.Assertions.assertThrows(
                        ...
                        () -> billingService.calculateDailyCost(dailyLog)
                );

        assertEquals(
                "No valid water rate for given date",
